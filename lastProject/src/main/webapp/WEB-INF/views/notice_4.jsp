		...
		<div id="content">
			...
			<div class="location">
				<ul>
					...
					<li>고객지원</li>
					<li>공지사항</li>
					<li><strong>출제</strong></li>
				</ul>
			</div>
			<div class="content">
				<!-- 컨텐츠 타이틀 -->
				<h3 class="tit_content">출제</h3>
				<!-- //컨텐츠 타이틀 -->
				<!-- 컨텐츠 내용 -->
				<div>
					<div class="searchType">
						<span> <label for="notiType">검색</label> <select
							name="notiType" id="notiType" title="검색 카테고리 선택" class="m0">
								...
								<option value="40" selected="selected">출제</option>
						...
						<div class="tbl_type1">
							<table summary="번호,제목,담당부서,최종수정일자 항목으로 정보 제공"
								...
								<tbody>
									...
									<tr>
										<td>2</td>
										<td class="tit" title="배관기능장 개인지참 공구 관련 내용 알림"><a
											href="#" onclick="goNext('5199622', '1')">배관기능장 개인지참 공구
												관련 내용 알림</a></td>
										<td>기술자격출제실 ..</td>
										<td>2017.03.17</td>
									</tr>
									<tr>
										<td>3</td>
										<td class="tit" title="2017년도 공조냉동기계기사 실기시험 평가방법 개선 알림"><a
											href="#" onclick="goNext('5199255', '1')">2017년도 공조냉동기계기사
												실기시험 평가방법 개선 알...</a></td>
										<td>기술자격출제실 ..</td>
										<td>2017.03.02</td>
									</tr>
									<tr>
										<td>4</td>
										<td class="tit" title="기계가공기능장 실기시험 과제 제출방법 변경알림"><a
											href="#" onclick="goNext('5199012', '1')">기계가공기능장 실기시험 과제
												제출방법 변경알림</a></td>
										<td>기술자격출제실 ..</td>
										<td>2017.01.18</td>
									</tr>
									<tr>
										<td>5</td>
										<td class="tit" title="화약류제조기사 및 화약류제조산업기사 실기시험 평가방법 변경 안내">
											<a href="#" onclick="goNext('5198944', '1')"><b>화약류제조기사
													및 화약류제조산업기사 실기시험 평가방...</b></a>
										</td>
										<td>기술자격출제실 ..</td>
										<td>2017.01.13</td>
									</tr>
									<tr>
										<td>6</td>
										<td class="tit" title="에너지관리기능장 개인지참공구 목록 변경사항 알림"><a
											href="#" onclick="goNext('5198914', '1')">에너지관리기능장 개인지참공구
												목록 변경사항 알림</a></td>
										<td>기술자격출제실 ..</td>
										<td>2017.01.06</td>
									</tr>
									<tr>
										<td>7</td>
										<td class="tit" title="용접기능장 실기시험 수험자 유의사항 추가 내용 안내"><a
											href="#" onclick="goNext('5198814', '1')">용접기능장 실기시험 수험자
												유의사항 추가 내용 안내...</a></td>
										<td>기술자격출제실 ..</td>
										<td>2016.12.21</td>
									</tr>
									<tr>
										<td>8</td>
										<td class="tit" title="철도전기신호기능사 실기시험문제 사전공개"><a href="#"
											onclick="goNext('5198444', '1')">철도전기신호기능사 실기시험문제 사전공개</a></td>
										<td>기술자격출제실 ..</td>
										<td>2016.11.26</td>
									</tr>
									<tr>
										<td>9</td>
										<td class="tit" title="2017년도 이용사 실기시험문제 공개"><a href="#"
											onclick="goNext('5195202', '1')">2017년도 이용사 실기시험문제 공개</a></td>
										<td>기술자격출제실 ..</td>
										<td>2016.09.02</td>
									</tr>
									<tr>
										<td>10</td>
										<td class="tit" title="미용사(일반) 출제기준 등재 알림"><a href="#"
											onclick="goNext('5117249', '1')">미용사(일반) 출제기준 등재 알림</a></td>
										<td>기술자격출제실 ..</td>
										<td>2014.12.18</td>
									</tr>
								</tbody>
