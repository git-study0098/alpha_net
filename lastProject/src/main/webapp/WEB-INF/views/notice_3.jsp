		...
		<div id="content">
			<div class="location">
				<ul>
					...
					<li>고객지원</li>
					<li>공지사항</li>
					<li><strong>시행</strong></li>
				</ul>
			</div>
			
			<div class="content">
				<!-- 컨텐츠 타이틀 -->
				<h3 class="tit_content">시행</h3>
				<!-- //컨텐츠 타이틀 -->
				<!-- 컨텐츠 내용 -->
				<div>
					<div class="searchType">
						<span> <label for="notiType">검색</label> <select
							name="notiType" id="notiType" title="검색 카테고리 선택" class="m0">
								...
								<option value="30" selected="selected">시행</option>
						...
						<div class="tbl_type1">
							<table summary="번호,제목,담당부서,최종수정일자 항목으로 정보 제공"
								...
								<tbody>
									<tr>
										<td>1</td>
										<td class="tit" title="기사 제3회 1차 최종합격자 발표"><a href="#"
											onclick="goNext('5198019', '1')"><b>기사 제3회 1차 최종합격자
													발표</b></a></td>
										<td>능력평가국 기술..</td>
										<td>2016.10.27</td>
									</tr>
									<tr>
										<td>2</td>
										<td class="tit" title="임상심리사 1급 응시자격 안내"><a href="#" onclick="goNext('5117604', '1')"><b>임상심리사 1급 응시자격 안내</b></a>
										</td>
										<td>능력평가국 기술..</td>
										<td>2015.08.24</td>
									</tr>
									<tr>
										<td>3</td>
										<td class="tit" title="한국건설기술인협회 경력증명서 온라인 제출 알림"><a
											href="#" onclick="goNext('5138416', '1')">한국건설기술인협회 경력증명서
												온라인 제출 알림</a></td>
										<td>능력평가국 기술..</td>
										<td>2015.07.03</td>
									</tr>
									<tr>
										<td>4</td>
										<td class="tit" title="2015년도 기사 제2회 필기시험 응시자격 불합격자 공고">
											<a href="#" onclick="goNext('5138413', '1')">2015년도 기사
												제2회 필기시험 응시자격 불합격자 공고...</a>
									...
									<tr>
										<td>5</td>
										<td class="tit" title="2015년 기술사 제106회 필기 합격현황"><a
											href="#" onclick="goNext('5137022', '1')">2015년 기술사 제106회
												필기 합격현황</a></td>
										<td>능력평가국 기술..</td>
										<td>2015.06.18</td>
									</tr>
									<tr>
										<td>6</td>
										<td class="tit" title="기사 제2회 필기 합격(예정)자 발표"><a href="#"
											onclick="goNext('5136006', '1')">기사 제2회 필기 합격(예정)자 발표</a></td>
										<td>능력평가국 기술..</td>
										<td>2015.06.11</td>
									</tr>
									<tr>
										<td>7</td>
										<td class="tit"
											title="기사 제1회 최종합격자 중 기사 제2회 필기시험 과목면제대상자 신청 안내"><a
											href="#" onclick="goNext('5073005', '1')"><b>기사 제1회
													최종합격자 중 기사 제2회 필기시험 과목면...</b></a></td>
										<td>능력평가국 기술..</td>
										<td>2015.05.31</td>
									</tr>
									<tr>
										<td>8</td>
										<td class="tit" title="2015년도 정기 기술사 제105회 면접 결과현황"><a
											href="#" onclick="goNext('5133401', '1')">2015년도 정기 기술사
												제105회 면접 결과현황...</a></td>
										<td>능력평가국 기술..</td>
										<td>2015.05.19</td>
									</tr>
