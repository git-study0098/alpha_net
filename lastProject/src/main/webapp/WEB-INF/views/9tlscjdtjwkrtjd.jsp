			...
			<div class="content">
				...
				<div class="step">
					<ul class="list06">
						...
						<li><img src="../images/step/step_license_off_02.gif"
							alt=""><span>선택확인</span></li>
						<li><img src="../images/step/step_license_on_03.gif"
							alt=""><span>신청서작성</span><span class="blind">선택</span></li>
						<li><img src="../images/step/step_license_off_04.gif"
							alt=""><span>본인인증</span></li>
						<li><img src="../images/step/step_license_off_06.gif"
							alt=""><span>수수료결제</span></li>
						<li><img src="../images/step/step_license_off_05.gif"
									...
									<td colspan="4" class="intbl_div">
										<div>
											<span class="mr20"> <span class="txt_addr"><label
												...
												<button type="button">
													<input type="image" id="datepicker" src="../images/common/btn_calendar_bg.png">
