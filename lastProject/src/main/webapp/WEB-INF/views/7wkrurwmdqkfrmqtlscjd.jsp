	...
	<div id="container">
		...
		<div id="content">
			...
			<div class="content">
				...
				<div class="step">
					<ul class="list06">
						<li><img src="../images/step/step_license_off_01.gif"
							alt=""><span>자격증선택</span></li>
						<li class="arrow"><img src="../images/step/step_license_off_02.gif"
							alt=""><span>선택확인</span></li>
						<li class="arrow"><img src="../images/step/step_license_off_03.gif"
							alt=""><span>신청서작성</span></li>
						<li  class="arrow"><img src="../images/step/step_license_off_04.gif"
							alt=""><span>본인인증</span></li>
						<li  class="arrow"><img src="../images/step/step_license_off_06.gif"
							alt=""><span>수수료결제</span></li>
						<li  class="arrow"><img src="../images/step/step_license_off_05.gif"
				...
				<div class="cont_parbx mb40">
					...
					<ul class="list">
						...
						<li>자격증 배송절차
							<p class="center_img">
								<img src=../images/content/isr001_01_img01.gif
