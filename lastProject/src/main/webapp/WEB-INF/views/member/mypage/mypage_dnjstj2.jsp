...
<article>
			...
			<div class="content">
					...
					<div class="tbl_type1">
						<table summary="국가기술자격 시험일정 안내로, 응시시험, 접수기간, 선택 정보 제공">
							...
							<tbody>
								...
								<tr>
									<td class="left">2017년 정기 기술사 113회 필기 </td>
						
						
									<td>2017년 7월 7일 (금) 오전 09:00 ~ 2017년 7월 13일 (목) 오후 06:00</td>
						
									<td><button type="button" class="btn3_type1" title="접수하기" onclick="goHiddenChk('01','1','2017','113','PL2017456004','1','20170707','T','1', '2017년 정기 기술사 113회 필기', '1', '','A');"><span>접수하기</span></button></td>
								</tr>
				...
				<div class="accept">
					<div class="accept_wrap">
						...
						<div class="in_menu">
							<a href="#" class="page_link" title="새 창"><span>국가전문자격 전체보기 및 홈페이지 바로가기</span></a>
						</div>
	...
	<li class="wrap">
		<ul class="nobg">
			...
			<!-- 밑에 버튼 패딩 0줫음 -->						
						<button style="padding:0;" title="상시시험 원서 접수하기. 새 창" type="button" class="btn btncolor6" onclick="popup3('http://t.q-net.or.kr/')"><span>상시시험 원서 접수하기</span></button>
						</p>
						<ul class="inner_menu">
							<li>한식, 일식, 양식, 중식조리</li>
							<li>정보처리 / 정보기기운용</li>
