			...
			<div class="content">
				...
				<div class="step" id="rcvStep">
					<ul class="list01">
						...
						<li><img src="../images/step/step_original_off_05.gif" alt=""><span>장소선택</span></li>
						<li><img src="../images/step/step_original_on_06.gif" alt=""><span>결제하기</span><span
				...
				<div class="btn_center mb40">
					...
					<button type="button" name="payBtn" id="payBtn"
						class="btn2 btncolor1" onclick="location.href='../11결제.jsp'">
						<span>결제하기</span>
					</button>
				</div>
