...
<article>
	<div id="container">
		...
		<div id="content">
			...
			<div class="content">
				<!-- 컨텐츠 타이틀 -->
				<h3 class="tit_content">서비스개선</h3>
				<!-- //컨텐츠 타이틀 -->

				<!-- 컨텐츠 내용 -->
				<div>
					<div class="searchType">
						<span> <label for="groupCode">검색</label> <select
							name="groupCode" title="검색 유형 선택" id="groupCode" class="m0"
							style="width: 180px">
								<option value="">전체</option>
								<option value="1012">시험정보 및 관련법령</option>
								<option value="1010">자격증발급관련</option>
								<option value="1002">원서접수및서류제출</option>
								<option value="1011">기타</option>

						</select> <select name="schType" title="검색 구분 선택" id="schType" class="m0">
...
<!-- 여기에 c:choose문 같은 반복문 써서 표시하면 될듯 합니다 . -->
									<tr>
										<td>1</td>
										<td class="tit" title="사진 크기 조정은 이제 큐넷 사이트에서~!"><a
											href="#" onclick="goNext('5200210', '1')">사진등록에서 판독이 불가능하다는 메시지가 나오는데 큐넷 사진등록은 어떻게 하나요?</a></td>
										<td>2016.11.02</td>
									</tr>
