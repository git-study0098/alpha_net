	...
	<div id="container">
		...
		<div id="content">
			...
			<div class="content">
				...
				<!-- 컨텐츠 내용 -->
				<div class="step" id="rcvStep"> <ul class="list01">  	<li><img src="../images/step/step_original_off_01.gif" alt=""><span>자격선택</span><span class="blind">현재단계 자격선택</span></li> 	<li><img src="../images/step/step_original_on_09.gif" alt=""><span>종목선택</span></li> 	<li><img src="../images/step/step_original_off_03.gif" alt=""><span>응시유형</span></li> 	<li><img src="../images/step/step_original_off_04.gif" alt=""><span>추가입력</span></li> 	<li><img src="../images/step/step_original_off_05.gif" alt=""><span>장소선택</span></li> 	<li><img src="../images/step/step_original_off_06.gif" alt=""><span>결제하기</span></li> 	<li><img src="../images/step/step_original_off_07.gif" alt=""><span>접수완료</span></li> </ul></div>
