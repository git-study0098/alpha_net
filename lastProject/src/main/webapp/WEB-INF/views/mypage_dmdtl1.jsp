	...
	<div id="container">
		...
		<div id="content">
			...
			<div class="content">
				...
				<div class="step">
					<ul class="list02">
						<li><img src="resources/images/step/step_qualification_on_01.gif" alt=""><span>자격선택</span><span class="blind">선택</span></li>
						<li><img src="resources/images/step/step_qualification_off_02.gif" alt=""><span>학력정보입력</span></li>
						<li><img src="resources/images/step/step_qualification_off_03.gif" alt=""><span>경력정보입력</span></li>
						<li><img src="resources/images/step/step_qualification_off_06.gif" alt=""><span>기능대회수상경력</span></li>
						<li><img src="resources/images/step/step_qualification_off_05.gif" alt=""><span>진단결과</span></li>
					</ul>
				</div>
				<h4>응시자격 검색</h4>
				<div class="infoBox">
