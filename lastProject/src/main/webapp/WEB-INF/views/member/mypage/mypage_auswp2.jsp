	...
	<div id="container">
		...
		<div id="content">
			...
			<form name="schfrm" method="post" action="">
				...
				<input type="hidden" id="examKmVal" name="examKmVal" value="KM">

				<h3 class="tit_content">과목면제</h3>
				<!-- TAB -->
				...
				<div class="tbl_normal tdCenter">
					<table summary="과목면제 목록으로, 종목, 면제과목, 면제구분, 승인상태 정보 제공">
						<caption>과목면제 목록</caption>
						<colgroup>
							<col width="25%">
							<col width="30%">
							<col width="30%">
